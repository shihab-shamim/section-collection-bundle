...
//  // src/components/BplBlockPreview.js
// import { BlockPreview } from '@wordpress/block-editor';
// import { parse } from '@wordpress/blocks';
// import { Button, Popover } from '@wordpress/components';
// import { useState, useEffect, useRef } from '@wordpress/element';
// import { getStyleAttributes, styleItems, styles } from '../../../../../utils/options'; // Import your styleItems
...
//   return (
//     <div className="bpl-block-preview-container">
//       {styles.map((style, index) => (
//         <div
//           key={style.value}
//           className="bpl-preview-item"
//         >
//           <Button
//             className={`bpl-style-button ${value === style.value ? 'is-active' : ''}`}
